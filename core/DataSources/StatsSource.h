...
class CORE_EXPORT StatsSource : public DataSource
{
    ...
    Q_PROPERTY(TricksSortFilterModel *tricksSort READ tricksSort CONSTANT)
...
public:
    ...
    TricksSortFilterModel *tricksSort() const;
...
private:
    ...
    TricksSortFilterModel *m_pTricksSort{nullptr};
};
